...
public class Tyndr extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Advert {
     ...
     * @return the request
     */
    public Resolve resolve(java.lang.Integer id) throws java.io.IOException {
    ...
    public class Resolve extends TyndrRequest<com.appspot.tyndr_server.tyndr.model.MessagesStatusMessage> {
       ...
       * @since 1.13
       */
      protected Resolve(java.lang.Integer id) {
      ...
      public Resolve setId(java.lang.Integer id) {
        this.id = id;
        return this;
      }
  ...
  /**
   * An accessor for creating requests from the Msg collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Tyndr tyndr = new Tyndr(...);}
   *   {@code Tyndr.Msg.List request = tyndr.msg().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  /**
   * The "msg" collection of methods.
   */
  public class Msg {

    /**
     * Create a request for the method "msg.create".
     *
     * This request holds the parameters needed by the tyndr server.  After setting any optional
     * parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
    ...
    public class Create extends TyndrRequest<com.appspot.tyndr_server.tyndr.model.MessagesStatusMessage> {
      ...
      private static final String REST_PATH = "create-msg";
      ...
      public Create setMsg(java.lang.String msg) {
        this.msg = msg;
        return this;
      }
      ...
      public Create setReceiver(java.lang.String receiver) {
